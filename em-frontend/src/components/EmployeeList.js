        ...
        <tbody className='bg-black'>
          ...
          <td className="text-left px-6 py-4 whitespace-nowrap"> 
            <button 
             ...
             className='hover:text-green-500 hover:cursor-pointer bg-transparent border-none'
           > Edit 📝</button>
            <button 
            onClick={(e) => deleteEmployee(e, employee.id) }
            className='hover:text-red-500 hover:cursor-pointer bg-transparent border-none ml-4'
            > Delete 🗑️</button>
             </td>
          </tr>
          ))}
